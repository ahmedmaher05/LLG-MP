...
(function (global) {
    ...
    function observe(subject, topic, data) {
        switch (data) {
            ...
            case 'webvtt.font.opacity':
                ...
                var fontOpacity =
                    Services.prefs.getIntPref('webvtt.font.opacity') / 100;
                WebVTTSet.fontSet = makeColorSet(fontColor, fontOpacity);
                break;
            case 'webvtt.font.scale':
                fontScale =
                    Services.prefs.getIntPref('webvtt.font.scale') / 100;
                break;
            case 'webvtt.bg.color':
            case 'webvtt.bg.opacity':
                var backgroundColor = Services.prefs.getCharPref(
                    'webvtt.bg.color'
                );
                var backgroundOpacity =
                    Services.prefs.getIntPref('webvtt.bg.opacity') / 100;
                WebVTTSet.backgroundSet = makeColorSet(
                    backgroundColor,
                    backgroundOpacity
                );
                break;
            ...
            case 'webvtt.edge.type':
                ...
                WebVTTSet.edgeSet =
                    edgeTypeList[edgeType] + makeColorSet(edgeColor);
                break;
        }
    }
    ...
    WebVTT.processCues = function (window, cues, overlay) {
        ...
        paddedOverlay.style.position = 'relative';
        paddedOverlay.style.left = '0';
        paddedOverlay.style.right = '0';
        // paddedOverlay.style.top = "0";
        paddedOverlay.style.bottom = '0';
        paddedOverlay.style.height = '0%';
